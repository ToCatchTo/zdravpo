			...
			<Box sx={{ position: 'relative', display: 'flex', gap: { xl: '85px', sm: '65px' }, flexDirection: { md: 'row', xs: 'column' }, width: '100%' }}>
				...
				<Grid size={{ lg: 5, md: 6, xs: 12 }} offset={{ md: 7, xs: 1 }} sx={{ justifyContent: 'center', display: 'flex', pl: { lg: '85px', md: '45px', xs: '0px' } }}>
					<Box sx={{ width: 'fit-content' }}>
						...
						{/* Tlačítko */}
						<Box component="a" href='https://app.epoukazonline.cz/c/c3fa0aef1889' target='_blank' sx={{ textDecoration: 'none', display: 'flex', justifyContent: 'space-between', cursor: 'pointer', backgroundColor: colors.button, borderRadius: '20px', padding: '15px', alignItems: 'center', maxWidth: { md: '318px', xs: '288px' }, mt: { md: '30px', xs: '20px' }, '&:hover': { filter: 'brightness(0.95)' } }}>
						...
						<Typography sx={{ display: { md: 'none', xs: 'block' }, color: colors.text, fontSize: '16px', fontFamily: 'Onest', fontWeight: '400', maxWidth: { sm: '536px', xs: '318px' }, pl: { md: '10px', xs: '0px' }, pt: '28px', lineHeight: '21px' }}>
						...
						<Typography sx={{ color: colors.text, fontSize: '16px', fontFamily: 'Onest', fontWeight: '400', maxWidth: { sm: '536px', xs: '318px' }, pl: { md: '10px', xs: '0px' }, pt: '20px', lineHeight: '21px' }}>
						...
						<Typography sx={{ color: colors.text, fontSize: '16px', fontFamily: 'Onest', fontWeight: '400', maxWidth: { sm: '540px', xs: '318px' }, pl: { md: '10px', xs: '0px' }, pt: '20px', lineHeight: '21px' }}>
